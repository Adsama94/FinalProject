...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://finalproject-189010.appspot.com/_ah/api/";
  ...
  /**
   * Create a request for the method "getJavaJokes".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetJavaJokes#execute()} method to invoke the remote operation.
   *
   * @param joke
   * @return the request
   */
  public GetJavaJokes getJavaJokes(java.lang.String joke) throws java.io.IOException {
    GetJavaJokes result = new GetJavaJokes(joke);
    initialize(result);
    return result;
  }

  public class GetJavaJokes extends MyApiRequest<com.udacity.gradle.builditbigger.backend.myApi.model.MyBean> {
     ...
     * parameters, call the {@link GetJavaJokes#execute()} method to invoke the remote operation. <p>
     * {@link
     * GetJavaJokes#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param joke
     * @since 1.13
     */
    protected GetJavaJokes(java.lang.String joke) {
    ...
    @Override
    public GetJavaJokes setAlt(java.lang.String alt) {
      return (GetJavaJokes) super.setAlt(alt);
    }

    @Override
    public GetJavaJokes setFields(java.lang.String fields) {
      return (GetJavaJokes) super.setFields(fields);
    }

    @Override
    public GetJavaJokes setKey(java.lang.String key) {
      return (GetJavaJokes) super.setKey(key);
    }

    @Override
    public GetJavaJokes setOauthToken(java.lang.String oauthToken) {
      return (GetJavaJokes) super.setOauthToken(oauthToken);
    }

    @Override
    public GetJavaJokes setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetJavaJokes) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetJavaJokes setQuotaUser(java.lang.String quotaUser) {
      return (GetJavaJokes) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetJavaJokes setUserIp(java.lang.String userIp) {
      return (GetJavaJokes) super.setUserIp(userIp);
    }
    ...
    public GetJavaJokes setJoke(java.lang.String joke) {
      this.joke = joke;
      return this;
    }

    @Override
    public GetJavaJokes set(String parameterName, Object value) {
      return (GetJavaJokes) super.set(parameterName, value);
    }
  }
